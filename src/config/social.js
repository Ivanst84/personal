export default {
  networks: [
    {
      name: 'youtube',
      url: 'https://www.youtube.com/@ivansosa3100?sub_confirmation=1',
    ...
    {
      name: 'linkedin',
      url: 'www.linkedin.com/in/ivanst08',
